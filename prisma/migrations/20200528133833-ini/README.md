# Migration `20200528133833-ini`

This migration has been generated by I Chen Wu at 5/28/2020, 1:38:33 PM.
...
"addressId" integer  NOT NULL ,"contactId" integer  NOT NULL ,"description" text  NOT NULL ,"id" SERIAL,"name" text  NOT NULL ,"ownerId" integer   ,"platformId" integer  NOT NULL ,"slug" text  NOT NULL ,
    PRIMARY KEY ("id"))
...
migration 20200528122600-init..20200528133833-ini
--- datamodel.dml
+++ datamodel.dml
@@ -1,7 +1,7 @@
 datasource db {
