# Migration `20200526155921-ee`

This migration has been generated by I Chen Wu at 5/26/2020, 3:59:21 PM.
...
"basket" jsonb   ,"customer_id" integer   ,"date" timestamp(3)   DEFAULT CURRENT_TIMESTAMP,"delivery_fees" Decimal(65,30)   ,"id" integer  NOT NULL ,"reference" text   ,"returned" boolean   ,"status" text   ,"tax_rate" Decimal(65,30)   ,"taxes" Decimal(65,30)   ,"total" Decimal(65,30)   ,"total_ex_taxes" Decimal(65,30)   ,
    PRIMARY KEY ("id"))
